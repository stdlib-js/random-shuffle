...
```javascript
import shuffle from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-shuffle@v0.2.3-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-shuffle@v0.2.3-deno/mod.js';
```
